...
#  D E F A U L T
    ...
    Key([mod, "control"], "Left", lazy.layout.shuffle_left(), desc="Move window to the"),
    Key([mod, "control"], "Right", lazy.layout.shuffle_right(), desc="Move window to the"),
    ...
    Key([mod, "shift"], "Right", lazy.layout.grow_right(), desc="Grow window to the righ"),
